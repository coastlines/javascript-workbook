...
const sumEvens = () => {
  let sumEvenNumbers = numArray.filter(e => e % 2 == 0).reduce((a,c) => a + c,0);
...
const weatherStates = [...new Set(weather.map(weather => weather.weather_state_name))];
